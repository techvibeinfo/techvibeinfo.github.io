...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
		...
		<!-- Page Title -->
        <title>Tulsi Greens || Greenary Begins Here...</title>		
		<!-- Meta Description -->
    ...
    <body id="body">
				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="item active" style="background-image: url(img/banner.jpg);">
						<div class="carousel-caption">
							<h2 data-wow-duration="700ms" data-wow-delay="500ms" class="wow bounceInDown animated"><span style="font-family:CHILLER;color:#04911e"> Tulsi Green</span>!</h2>
							<h3 data-wow-duration="1000ms" class="wow slideInLeft animated"><span class="color">/Greenary</span> Begins Here</h3>
							<p data-wow-duration="1000ms" class="wow slideInRight animated">other words...</p>
		...
		<div class="about" id="about">
			<div class="container">
				<h3>ABOUT US</h3>
				<h6>🌱 Tulsi Greens🌿 is a venture with a motto of "save earth by promoting greenery".

We are pioneers, consultants, experts & not but least the garden loves.</h6>
				<div class="about-grids">
				<div class="about-grid1">
					<div class="col-md-8 col-sm-8 about-text">
						<h4>Passion</h4>
						<p>We follow our passion, we are prepared to work smart on new things and we wont limit our dreams</p>
					</div>
				...
				<div class="about-grid2">
					...
					<div class="col-md-8 col-sm-8 about-text about-text2">
						<h4>Technology</h4>
						<p>The technology keeps moving forward and we are moving with top line . We always love innovations.</p>
					</div>
					<div class="clearfix"></div>
				</div>
				...
				<div class="about-grid3 ">
					<div class="col-md-8 col-sm-8 about-text">
						...
						<p>Our vision of the professionalism is enrich with value of relationship and value of precious time.</p>
					</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="sec-sub-title text-center wow fadeInRight animated" data-wow-duration="500ms">
						<p>A well maintained garden provides a great look and feel to any home and increases the appeal of your property. We can tailor a garden maintenance program to suit your garden’s needs or simply provide a once off visit.

Our gardening care and maintenance services incorporate all aspects of gardening:</p>
					</div>

					<!-- single member -->
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms">
						<div class="member-thumb">
							<img src="img/indore.jpg" alt="Team Member" class="img-responsive">
						</div>
						<h4>Indoor gardening</h4>
						<span>Improvements in plant lighting have helped indoor gardens grow by leaps and bounds. Today it’s possible to produce fresh veggies and beautiful flowers in your own home year round!</span>
					</figure>
					<!-- end single member -->
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="300ms">
						<div class="member-thumb">
							<img src="img/vertical.jpg" alt="Team Member" class="img-responsive">
						</div>
						<h4>Vertical gardening</h4>
						<span>Vertical gardens are an alternative for gardeners who don't have a lot of horizontal space, want to cover an unattractive wall, or just want something different.</span>
					</figure>
					<!-- end single member -->
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="600ms">
						<div class="member-thumb">
							<img src="img/ornament.jpg"  alt="Team Member" class="img-responsive">
						</div>
						<h4>Ornamental plants & Lactic Hanging plants</h4>
						<span>Hanging plant baskets bring an unmatched elegance to an area, be it outdoors or indoors. Flowering plants look especially chic when planted in hanging baskets.</span>
					</figure>
					<!-- end single member -->
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="900ms">
						<div class="member-thumb">
							<img src="img/deneb.jpg" alt="Team Member" class="img-responsive">
						</div>
						<h4>Deneb Outdoor gardening</h4>
						<span>Deneb table is an archetype of cool minimalism. The Deneb table design plays with the shapes of the four legs unnoticedly.
The anodised aluminium frame is assembled from four precision engineered elements that fit seamlessly together.</span>
					</figure>
					<!-- end single member -->
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-duration="500ms">
						<div class="footer-single">
							...
							<p>Tulsigreens,<br>Mathikere,<br>Bangalore-560054<br>9620381118</p>
						</div>
					</div>
